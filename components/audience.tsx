    ...
    <section className="bg-secondary">
      <div className="mx-auto max-w-7xl px-5 py-20 sm:px-8 lg:py-28">
        ...
        <div className="mt-14 grid gap-8 lg:grid-cols-2">
          <div className="rounded-3xl border border-agro/20 bg-card p-8 shadow-sm">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              {producers.map(({ icon: Icon, label }) => (
                <div
                  key={label}
                  className="flex items-center gap-3 rounded-2xl bg-agro-soft px-4 py-4"
                >
          ...
          <div className="rounded-3xl border border-marine/20 bg-card p-8 shadow-sm">
            ...
            <div className="mt-6 grid grid-cols-2 gap-4">
              {buyers.map(({ icon: Icon, label }) => (
                <div
                  key={label}
                  className="flex items-center gap-3 rounded-2xl bg-marine-soft px-4 py-4"
                >
